import { Client, VoiceState, GuildMember, Guild, VoiceChannel, User, GuildAuditLogs, GuildAuditLogsEntry, ClientEvents } from 'discord.js'

namespace DiscordAdvancedEvents {
